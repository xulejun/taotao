 ...
 * Generated at: 2020-04-16 00:32:05 UTC
...
public final class content_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("//文档加载时处理以下的逻辑\r\n");
      out.write("$(function(){\r\n");
      out.write("\tvar tree = $(\"#contentCategoryTree\");//获取树\r\n");
      out.write("\tvar datagrid = $(\"#contentList\");//获取表格\r\n");
      out.write("\ttree.tree({//创建一颗树\r\n");
      out.write("\t\t//url:'/content/category/list\r\n");
      out.write("\t\t//点击树的节点的时候触发\r\n");
      out.write("\t\tonClick : function(node){\r\n");
      out.write("\t\t\t//判断如果点击的节点是叶子节点\r\n");
      out.write("\t\t\tif(tree.tree(\"isLeaf\",node.target)){\r\n");
      out.write("\t\t\t\t//加载表格中的数据  重新发送URL请求 加载数据\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('reload', {\r\n");
      out.write("\t\t\t\t\t//发送请求的参数：categoryId :分类的id \r\n");
      ...
      out.write("    \t//表示获取树中被选中的节点\r\n");
      out.write("    \tvar node = $(\"#contentCategoryTree\").tree(\"getSelected\");\r\n");
      out.write("    \t//if(node)  表示有节点\r\n");
      out.write("    \t//$(\"#contentCategoryTree\").tree(\"isLeaf\",node.target)：获取节点，判断是否为叶子节点  表示是叶子\r\n");
      out.write("    \t//如果没有选择节点或者选择的节点为父节点。\r\n");
      out.write("    \tif(!node || !$(\"#contentCategoryTree\").tree(\"isLeaf\",node.target)){\r\n");
      out.write("    \t\t$.messager.alert('提示','新增内容必须选择一个内容分类!');\r\n");
      out.write("    \t\treturn ;\r\n");
      out.write("    \t}\r\n");
      out.write("    \t//表示选中的是叶子节点，处理以下的业务\r\n");
      out.write("    \t//创建窗口\r\n");
      out.write("    \tTT.createWindow({\r\n");
      out.write("    \t\t//动态的发送url /content-add  获取JSP页面，展示在窗口中\r\n");
